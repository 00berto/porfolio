  ...
  "node_modules/basicscroll/dist/basicScroll.min.js"(exports, module) {
    !function(t) {
      ...
      return function t(n, o, e) {
        ...
        for (var u = "function" == typeof __require && __require, i = 0; i < e.length; i++) r(e[i]);
        return r;
      }({ 1: [function(t, n, o) {
        ...
        o.create = function(t2) {
          var n2 = null, o2 = false, e2 = { isActive: function() {
            ...
            n2 = function() {
              ...
              }), null == t3.direct && (t3.direct = false), null == t3.track && (t3.track = true), null == t3.props && (t3.props = {}), null == t3.from) throw new Error("Missing property `from`");
              if (null == t3.to) throw new Error("Missing property `to`");
              if ("function" != typeof t3.inside) throw new Error("Property `inside` must be undefined or a function");
              if ("function" != typeof t3.outside) throw new Error("Property `outside` must be undefined or a function");
              if ("boolean" != typeof t3.direct && t3.direct instanceof HTMLElement == 0) throw new Error("Property `direct` must be undefined, a boolean or a DOM element/node");
              if (true === t3.direct && null == t3.elem) throw new Error("Property `elem` is required when `direct` is true");
              if ("boolean" != typeof t3.track) throw new Error("Property `track` must be undefined or a boolean");
              if ("object" !== i(t3.props)) throw new Error("Property `props` must be undefined or an object");
              if (null == t3.elem) {
                if (false === m(t3.from)) throw new Error("Property `from` must be a absolute value when no `elem` has been provided");
                if (false === m(t3.to)) throw new Error("Property `to` must be a absolute value when no `elem` has been provided");
              } else true === h(t3.from) && (t3.from = y(t3.from, t3.elem)), true === h(t3.to) && (t3.to = y(t3.to, t3.elem));
              return t3.from = b(t3.from), t3.to = b(t3.to), t3.props = Object.keys(t3.props).reduce(function(n3, o3) {
                ...
                if (false === m(e3.from)) throw new Error("Property `from` of prop must be a absolute value");
                if (false === m(e3.to)) throw new Error("Property `from` of prop must be a absolute value");
                if (e3.from = b(e3.from), e3.to = b(e3.to), null == e3.timing && (e3.timing = r.default.linear), "string" != typeof e3.timing && "function" != typeof e3.timing) throw new Error("Property `timing` of prop must be undefined, a string or a function");
                if ("string" == typeof e3.timing && null == r.default[e3.timing]) throw new Error("Unknown timing for property `timing` of prop");
          ...
          for (var t2 = arguments.length, n2 = new Array(t2), o2 = 0; o2 < t2; o2++) n2[o2] = arguments[o2];
